...
load_table tsv generifs_basic   generifs_basic

load_table tsv gene_info        Homo_sapiens.gene_info
...
# @TODO: interactions.gz 
# @TODO: interaction_sources
# @TODO: gene2refseq

# load_table tsv gene2refseq     gene2refseq 
# load_table tsv gene2accession  gene2accession
