...
select distinct D.*
from  MGREL as Relate, view_preferred_disease as D
...
select distinct D.*
from  view_disease_subtype as Relate, view_preferred_disease as D
...
select 'GTR ==> (Genetic Testing Registry) , lots of entries for Familial HCM' as example; 
-- +---------------------+-------------+----------+-------------------------------------------------------+
-- | SemanticType        | SourceVocab | Disease  | Name                                                  |
-- +---------------------+-------------+----------+-------------------------------------------------------+
...
select * from GTR.test_condition_gene where GTR_identifier = 'C1834460'; 
