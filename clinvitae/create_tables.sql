...
drop   table if exists clinvitae_hgvs;
create table           clinvitae_hgvs
(
    hgvs_text       varchar(100) not null,      -- 'Nucleotide Change'
    gene_name       varchar(20) default null,   -- 'Gene'
